<div class="phone-screen">
  ...
  <section class="content">
    <ul class="categories">
      ...
      <li>
        <svg id="icon-music" viewBox="0 0 32 32">
      ...
      <li>
        <svg id="icon-feed" viewBox="0 0 32 32">
      ...
      <li>
        <svg id="icon-note" viewBox="0 0 20 20">
          <path d="M14.971 9.438c-0.422 0.656-0.646 0.375-0.52 0 0.336-0.993 0.348-4.528-2.451-4.969l-0.002 11.531c0 1.657-1.735 4-4.998 4-1.657 0-3-0.871-3-2.5 0-2.119 1.927-3.4 4-3.4 1.328 0 2 0.4 2 0.4v-14.5h2c0 2.676 5.986 4.744 2.971 9.438z"></path>
        </svg>
        <span>Songs</span>
      </li>
      <li>
        <svg id="icon-vynil" viewBox="0 0 32 32">
      ...
      <li>
        <svg id="icon-user-plus" viewBox="0 0 32 32">
      ...
      <li>
        <svg id="icon-podcast" viewBox="0 0 32 32">
          <title>podcast</title>
      ...
      <li>
        <svg id="icon-play2" viewBox="0 0 32 32">
    ...
    <section class="recent">
      ...
      <div class="recent-playlists">
        <article class="playlist">
          ...
          <div class="info">
            <h1>Release Radar</h1>
            <p>Made for ayooluwa</p>
          </div>
          <svg id="icon-dots-three-vertical" viewBox="0 0 20 20">
        ...
        <article class="playlist">
          <div class="cover"></div>
          <div class="info">
            <h1>Invasion of Privacy</h1>
            <p>Album • by Cardi B</p>
          </div>
          <svg id="icon-dots-three-vertical" viewBox="0 0 20 20">
            <path d="M10.001 7.8c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2c1.215 0 2.199-0.985 2.199-2.2s-0.984-2.2-2.199-2.2zM10.001 5.2c1.215 0 2.199-0.986 2.199-2.2s-0.984-2.2-2.199-2.2c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2zM10.001 14.8c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2c1.215 0 2.199-0.985 2.199-2.2s-0.984-2.2-2.199-2.2z"></path>
          </svg>
        ...
        <article class="playlist">
          <div class="cover"></div>
          <div class="info">
            <h1>This is Machine Gun Kelly</h1>
            <p>Playlist • by Spotify</p>
          </div>
          <svg id="icon-dots-three-vertical" viewBox="0 0 20 20">
            <path d="M10.001 7.8c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2c1.215 0 2.199-0.985 2.199-2.2s-0.984-2.2-2.199-2.2zM10.001 5.2c1.215 0 2.199-0.986 2.199-2.2s-0.984-2.2-2.199-2.2c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2zM10.001 14.8c-1.215 0-2.201 0.985-2.201 2.2s0.986 2.2 2.201 2.2c1.215 0 2.199-0.985 2.199-2.2s-0.984-2.2-2.199-2.2z"></path>
  ...
  <footer class="footer">
    <div class="now-playing">
      ...
      <div class="song-title">
        <span class="song">The Scientist</span>
        <span class="artist"> • by Coldplay</span>
      </div>
    ...
    <nav class="footer-nav">
      <ul class="nav-items">
        ...
        <li class="library">
          <svg id="icon-books" viewBox="0 0 36 32">
            <title>books</title>
